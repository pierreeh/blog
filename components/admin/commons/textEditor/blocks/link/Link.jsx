...
export default function Link({ attributes, element, children }) {
  ...
  return (
    <>
      ...
      {selected && focused && (
        <div contentEditable={false} style={{ userSelect: 'none', display: 'flex', alignItems: 'center', position: 'absolute', zIndex: 1, background: 'white', padding: '.25rem .5rem', boxShadow: '.25rem .25rem .75rem rgba(0,0,0,.16)', borderRadius: '6px' }}>
          <p>
            {element.url}
          </p>
